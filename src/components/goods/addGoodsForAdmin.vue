<template>
  <el-card class="addGoodsBox-card">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>增加产品</el-breadcrumb-item>
    </el-breadcrumb>
    <!--    提示信息-->
    <el-alert
      title="上架产品"
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-tabs v-model="active" tab-position="left">
        ...
        <el-tab-pane name="1" label="基本信息">
          ...
          <el-form-item label="供货商编号" prop="gsalerId" class="formItemFirst">
            <el-input
              v-model="ruleForm.gsalerId"
              clearable
              placeholder="请输入供货商编号" >
            </el-input>
          </el-form-item>

          <el-form-item label="供货商昵称" prop="gsalerName" class="formItemOthers">
            <el-input
              v-model="ruleForm.gsalerName"
              clearable
              placeholder="请输入供货商昵称" >
            </el-input>
          </el-form-item>

          <el-form-item label="产品名称" prop="gname" class="formItemOthers">
            <el-input
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        gsalerName: [
          { required: true, message: '请输入供货商昵称', trigger: 'blur' }
        ],
        gsalerId: [
      ...
      actionAddr: 'http://www.zhanghuipeng.club:9233/files/up',
      headers: {
